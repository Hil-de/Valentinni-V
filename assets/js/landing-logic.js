//funcion para cambiar color al navbar en la pagina principal 
...
window.addEventListener('scroll', function () {
    ...
    links.forEach(link => {
        if (scrollY > 100) {
            link.style.setProperty('--line_color', '#000000');
        } else {
            link.style.setProperty('--line_color', getComputedStyle(document.documentElement).getPropertyValue('--p-color'));
        }
    });
});
